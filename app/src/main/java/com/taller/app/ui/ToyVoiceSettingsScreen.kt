...
fun ToyVoiceSettingsScreen(onBack: () -> Unit) {
    ...
    Column(
        ...
        when (providerType) {
            ...
            // FINAL-CORE02: Azure, ElevenLabs y la voz local del dispositivo estan
            // retirados. Cualquier configuracion antigua se normaliza a Gemini.
            else -> Unit
        }
...
private fun ProviderSelectionSection(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            ProviderStatusLine("Estado Gemini (principal)", geminiConfigured)
            ProviderStatusLine("Estado OpenAI (respaldo)", openAiConfigured)
            Text(
            ...
            ProviderOption(
                ...
                description = "Voz principal oficial de Seven. Si falla, usa OpenAI como respaldo.",
            ...
            ProviderOption(
                ...
                description = "Respaldo oficial de Gemini. Si falla, se intenta Gemini.",
            ...
            Text(
                text = "Si ninguno esta configurado, Seven mostrara un aviso de configuracion en lugar de hablar.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Text(
                text = if (configured) {
                    ...
                    "Falta OPENAI_API_KEY en local.properties. Sin ella no hay respaldo de Gemini."
                },
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
...
private fun PlaybackStatusCard(
    ...
    val activeProviderLabel = providerLabel(providerType)
